                                ...
                                <a href="<?php the_permalink(); ?>">
                                    <div class="card text-dark card-has-bg click-col">
                                        ...
                                        <div class="card-img-overlay d-flex flex-column">
                                            <div id="card-footer" class="justify-content-between"
                                                 style="display: flex;">
            ...
            function loadProjects(page) {
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        // Scroll to the top of the project cards
                        $('html, body').animate({
                            scrollTop: $(".projects-container").offset().top - 50 // Adjust offset as needed
                        }, 500);
                    }
                });
            }
